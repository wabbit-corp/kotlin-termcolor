...
object Terminal {
    ...
    /**
     * Returns true if the current environment appears to support ANSI colors. It checks for
     * NO_COLOR, dumb terminals, and uses System.console() if available. On Windows, it also returns
     * true if running in Windows Terminal.
     */
