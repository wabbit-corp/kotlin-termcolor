...
// managed-integrity-v1: inQXnizf5Rv
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-termcolor", project.version.toString())
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-termcolor"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.termcolor"
        compileSdk = 34
        minSdk = 26
    }
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-termcolor/tree/master/src")
