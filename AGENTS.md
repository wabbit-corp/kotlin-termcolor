...
- Canonical repo target: `kotlin-termcolor`. Useful entrypoints: `dev project show kotlin-termcolor`, `dev build kotlin-termcolor`, `dev check kotlin-termcolor`.
- Setup-managed files are regenerated with `dev setup kotlin-termcolor`; avoid hand-editing stamped generated files.
